...
dset = xr.open_dataset("/mnt/c/Users/Arthur/Documents/IC/3.3/GPCC.nc")

#--- read variable
lat = dset.lat.values
lon = dset.lon.values
var = dset['precip'][949:1319,:,:].values  # precip[time,lat,lon] select Jan1981 to Dec2010
print(lat)  
print(lon)
#--- Temporal mean
...
#---- Plots
wks = Ngl.open_wks("png","GPCC") #figure name
